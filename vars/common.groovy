...
def artifactUpload() {
    ...
    sh 'aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 191164592803.dkr.ecr.us-east-1.amazonaws.com'

    sh 'docker push 191164592803.dkr.ecr.us-east-1.amazonaws.com/${component}:${TAG_NAME}'
